...
def train_model(
    ...
    frame = attach_labels(
        pool_features(retrieval, runs, train_queries, train_key, items, item_vectors, timings),
...
def main() -> None:
    ...
    fixed_valid_texts(train_contexts)
    ...
    if args.model is not None:
        ...
        model, train_info = train_model(
            args, retrieval, ranker, features, corpus, train_contexts, items, item_vectors, timings
        )
    ...
    del train_contexts, item_vectors
